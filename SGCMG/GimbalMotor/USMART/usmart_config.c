...
//	(void*)test_fun,"void test_fun(void(*ledset)(u8),u8 sta)",	
	(void*)testUsmart, "void testUsmart(char* str)",
	(void*)TIM_SetTIM1CH4CCR,"void TIM_SetTIM1CH4CCR4(u32 compare)",
	(void*)changeFixedSpeed,"void changeFixedSpeed(u16 newSpeed)",
	(void*)tmc260SetMicroStep,"void tmc260SetMicroStep(u8 micro)" ,
	(void*)setDesiredPoint,"void setDesiredPoint(double x)"
};						  
///////////////////////////////////END///////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
//函数控制管理器初始化
